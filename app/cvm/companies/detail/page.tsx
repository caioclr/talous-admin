...
const ipeColumns: DataTableColumn<IPEDisclosureSummary>[] = [
  ...
  },
  {
    ...
    header: "Detalhe",
    render: (row) => (
      <Link className="text-primary underline-offset-4 hover:underline" href={`/cvm/ipe/disclosures/detail?id=${row.id}`}>
        Abrir
      </Link>
    ),
  },
          ...
          <Card>
            <CardHeader>
              <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                ...
                <Link
                  href={`/cvm/ipe/companies/detail?cd_cvm=${cdCvm}`}
          ...
          <Card>
            <CardHeader>
              <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                ...
                <Link
                  href={`/cvm/itr-dfp/companies/detail?cd_cvm=${cdCvm}`}
                  className="text-sm font-medium text-primary underline-offset-4 hover:underline"
                >
